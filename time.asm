...
int main(int argc, char* argv[])
{
  ...
  pid = fork();
  19:	e8 ad 02 00 00       	call   2cb <fork>

  if(pid > 0)
  1e:	85 c0                	test   %eax,%eax
  20:	7f 0e                	jg     30 <main+0x30>
  ...
  22:	74 38                	je     5c <main+0x5c>
    exec(argv[1],argv+1);
    exit();
  }


  24:	8d 65 f8             	lea    -0x8(%ebp),%esp
  ...
  2f:	c3                   	ret    
    int status = waitx(&wtime, &rtime);
  30:	8d 45 f4             	lea    -0xc(%ebp),%eax
  33:	52                   	push   %edx
  34:	52                   	push   %edx
  35:	50                   	push   %eax
  36:	8d 45 f0             	lea    -0x10(%ebp),%eax
  39:	50                   	push   %eax
  3a:	e8 34 03 00 00       	call   373 <waitx>
    printf(1,"Wait time = %d   Run Time = %d  with Status = %d\n",wtime,rtime,status);
  3f:	89 04 24             	mov    %eax,(%esp)
  42:	ff 75 f4             	pushl  -0xc(%ebp)
  45:	ff 75 f0             	pushl  -0x10(%ebp)
  48:	68 98 07 00 00       	push   $0x798
  4d:	6a 01                	push   $0x1
  4f:	e8 dc 03 00 00       	call   430 <printf>
    exit();
  54:	83 c4 20             	add    $0x20,%esp
  57:	e8 77 02 00 00       	call   2d3 <exit>
    exec(argv[1],argv+1);
  5c:	50                   	push   %eax
  5d:	50                   	push   %eax
  5e:	8d 43 04             	lea    0x4(%ebx),%eax
  61:	50                   	push   %eax
  62:	ff 73 04             	pushl  0x4(%ebx)
  65:	e8 a1 02 00 00       	call   30b <exec>
    exit();
  6a:	e8 64 02 00 00       	call   2d3 <exit>
  6f:	90                   	nop
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 d4 07 00 00 	movzbl 0x7d4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb ca 07 00 00       	mov    $0x7ca,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 605:	a1 90 0a 00 00       	mov    0xa90,%eax
{
 ...
 626:	73 10                	jae    638 <free+0x38>
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 657:	5e                   	pop    %esi
 658:	5f                   	pop    %edi
 659:	5d                   	pop    %ebp
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 90 0a 00 00       	mov    %eax,0xa90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 69d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6a0:	8b 3d 90 0a 00 00    	mov    0xa90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e9:	8b 3d 90 0a 00 00    	mov    0xa90,%edi
 ...
 712:	e8 e9 fe ff ff       	call   600 <free>
  return freep;
 717:	a1 90 0a 00 00       	mov    0xa90,%eax
 ...
 744:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 747:	a3 90 0a 00 00       	mov    %eax,0xa90
}
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf 94 0a 00 00       	mov    $0xa94,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 94 0a 00 00 94 	movl   $0xa94,0xa94
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 77b:	c7 05 98 0a 00 00 00 	movl   $0x0,0xa98
 782:	00 00 00 
    if(p->s.size >= nunits){
